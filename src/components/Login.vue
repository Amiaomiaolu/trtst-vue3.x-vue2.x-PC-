            ...
            <div class="login-wrapper">
                ...
                <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="">
                    <el-form-item prop="phone" label-width="">
                        <el-input v-model="loginForm.phone" placeholder="请输入网易云帐号登录" prefix-icon="iconfont icon-phone"></el-input>
                    </el-form-item>
                    <el-form-item prop="pwd" label-width="">
                        <el-input v-model="loginForm.pwd" placeholder="请输入密码" show-password prefix-icon="iconfont icon-pwd"></el-input>
                    </el-form-item>
                </el-form>
            </div>
            <template #footer>
